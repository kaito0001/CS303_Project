...
async function getCategory ( categoryname ) {
    const chatMessagesRef = collection(db, 'categories');
    const chatRef = doc(chatMessagesRef, categoryname);
    const qt = query(chatRef);
    // const qd = query(autoKeyRef,orderBy('messageDate'));
...
export { getDocFunc, updateDocFunc, deleteDocFunc, setDocFunc, getDocsFunc, addDocFunc, addProduct, getProductsByCategory ,getProductsBysubCategory,getCategory};